...
> **Status: engine complete; curriculum ~47% authored.** The full mastery-based learning engine (Phases 0–9), the adaptive diagnostic, and an isolated AI tutor are built, wired, and tested, and four Version 1 features have shipped on top. Curriculum expansion is underway: the **content** now covers ~65 of the ~138 documented topics across 63 skills (3 units complete, 8 partial, 5 missing) — recently adding Decimals & Percentages (Phase 10) and Numerical Structure + Integers (Phase 11), authored at mastery-grade depth. See [`docs/planning/PROJECT_SCOPE.md`](docs/planning/PROJECT_SCOPE.md) for the full scope beginning to end and [`docs/planning/ROADMAP.md`](docs/planning/ROADMAP.md) for the remaining phases. Every acceptance criterion in `docs/spec/11_TESTING_AND_ACCEPTANCE.md` maps to a passing test in [`docs/RELEASE_CHECKLIST.md`](docs/RELEASE_CHECKLIST.md).

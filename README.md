...
> **Status: engine complete; curriculum ~72% authored.** The full mastery-based learning engine (Phases 0–9), the adaptive diagnostic, and an isolated AI tutor are built, wired, and tested, and four Version 1 features have shipped on top. Curriculum expansion is well underway: the **content** now covers ~99 of the ~138 documented topics across 93 skills (9 units complete, 4 partial, 3 missing) — Phases 10–12 added Decimals & Percentages, Numerical Structure, Integers, Ratios, and Measurement Foundations, and Phase 13 completed the Addition/Subtraction, Multiplication/Division, Fractions, and Algebra units, all at mastery-grade depth. The main remaining gaps are Coordinate Plane & Graphs and the science Experiments/Data units. See [`docs/planning/PROJECT_SCOPE.md`](docs/planning/PROJECT_SCOPE.md) for the full scope beginning to end and [`docs/planning/ROADMAP.md`](docs/planning/ROADMAP.md) for the remaining phases. Every acceptance criterion in `docs/spec/11_TESTING_AND_ACCEPTANCE.md` maps to a passing test in [`docs/RELEASE_CHECKLIST.md`](docs/RELEASE_CHECKLIST.md).

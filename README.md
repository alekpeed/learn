...
> **Status: engine complete; curriculum ~78% authored.** The full mastery-based learning engine (Phases 0–9), the adaptive diagnostic, and an isolated AI tutor are built, wired, and tested, and four Version 1 features have shipped on top. Curriculum expansion is well underway: the **content** now covers ~108 of the ~138 documented topics across 101 skills (10 units complete, 4 partial, 2 missing). Phases 10–14 built out the **entire mathematics course** except partial Decimals/Percentages — most recently Coordinate Plane & Graphs (Phase 14), which added a new deterministic `point`/coordinate validator. The remaining gaps are all in the science course (Experiments and Data units, and partial Scientific Thinking/Measurement). See [`docs/planning/PROJECT_SCOPE.md`](docs/planning/PROJECT_SCOPE.md) for the full scope beginning to end and [`docs/planning/ROADMAP.md`](docs/planning/ROADMAP.md) for the remaining phases. Every acceptance criterion in `docs/spec/11_TESTING_AND_ACCEPTANCE.md` maps to a passing test in [`docs/RELEASE_CHECKLIST.md`](docs/RELEASE_CHECKLIST.md).
